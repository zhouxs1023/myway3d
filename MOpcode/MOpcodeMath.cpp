...
#define POINT_IN_TRI(V0,U0,U1,U2)           \
		...
		static bool coplanar_tri_tri(const Vec3& N, const Vec3 tri1[3],
			const Vec3 tri2[3])
		{
			float A[3];
			short i0,i1;
...
#define NEWCOMPUTE_INTERVALS(VV0,VV1,VV2,D0,D1,D2,D0D1,D0D2,A,B,C,X0,X1) \
		...
		*/
		...
		bool Intersect3::triangleTriangle(const Vec3 tri1[3],
			const Vec3 tri2[3])
		{
			Vec3 E1,E2;
			Vec3 N1,N2;
			...
			du0=(N1.Dot(tri2[0]))+d1;
			du1=(N1.Dot(tri2[1]))+d1;
			du2=(N1.Dot(tri2[2]))+d1;
			...
			dv0=(N2.Dot(tri1[0]))+d2;
			dv1=(N2.Dot(tri1[1]))+d2;
			dv2=(N2.Dot(tri1[2]))+d2;
...
#define SORT2(a,b,smallest)       \
	if(a>b)       \
		...
		static inline void isect2(const Vec3 tri[3],float VV0,float VV1,float VV2,
			float D0,float D1,float D2,float *isect0,float *isect1,Vec3 isectline[2])
		{
			float tmp=D0/(D0-D1);          
			Vec3 diff;
		...
		static inline bool compute_intervals_isectline(const Vec3 tri[3],
...
#define COMPUTE_INTERVALS_ISECTLINE(VERT0,VERT1,VERT2,VV0,VV1,VV2,D0,D1,D2,D0D1,D0D2,isect0,isect1,isectpoint0,isectpoint1) \
	...
	*/
		...
		Segment3& isectline, bool& coplanar)
	{
		...
		Vec3 isectpointA[2];
		Vec3 isectpointB[2]={Vec3::Zero,Vec3::Zero};
		float du0du1,du0du2,dv0dv1,dv0dv2;
		short index;
		float vp0,vp1,vp2;
		float up0,up1,up2;
