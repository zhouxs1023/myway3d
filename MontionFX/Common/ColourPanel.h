...
namespace common
{
	...
	{
		DECLARE_SINGLETON(ColourPanel);

	public:
		typedef MyGUI::delegates::CDelegate1<const MyGUI::Colour&> Event_PreviewColour;
		typedef MyGUI::delegates::CDelegate2<ColourPanel*, bool> EventHandle_Result;
	...
	public:
		...
		void DoModal(const MyGUI::Colour& _colour = MyGUI::Colour::White, bool _alpha = false);
