...
namespace Infinite {
	...
	Shape * xTree::Clone()
	{
		xTree * tree = (xTree *)ShapeManager::Instance()->Create(GetTypeName().c_str());
	...
	void xTreeFactory::_OnDragFile(Event * sender)
	{
		...
		xTree * obj = (xTree *)ShapeManager::Instance()->Create("Tree");
