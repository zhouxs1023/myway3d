...
void xPropertyGrid::OnExpandAllProperties()
{
	m_wndPropList.ExpandAll();
}

void xPropertyGrid::OnUpdateExpandAllProperties(CCmdUI* /* pCmdUI */)
{
}

void xPropertyGrid::OnSortProperties()
{
	m_wndPropList.SetAlphabeticMode(!m_wndPropList.IsAlphabeticMode());
}

void xPropertyGrid::OnUpdateSortProperties(CCmdUI* pCmdUI)
{
	pCmdUI->SetCheck(m_wndPropList.IsAlphabeticMode());
}

void xPropertyGrid::OnProperties1()
{
	// TODO: 在此处添加命令处理程序代码
}

void xPropertyGrid::OnUpdateProperties1(CCmdUI* /*pCmdUI*/)
{
	// TODO: 在此处添加命令更新 UI 处理程序代码
}

void xPropertyGrid::OnProperties2()
{
	// TODO: 在此处添加命令处理程序代码
}

void xPropertyGrid::OnUpdateProperties2(CCmdUI* /*pCmdUI*/)
{
	// TODO: 在此处添加命令更新 UI 处理程序代码
}
...
void xPropertyGrid::OnSetFocus(CWnd* pOldWnd)
{
	CDockablePane::OnSetFocus(pOldWnd);
	m_wndPropList.SetFocus();
}

void xPropertyGrid::OnSettingChange(UINT uFlags, LPCTSTR lpszSection)
{
	CDockablePane::OnSettingChange(uFlags, lpszSection);
	SetPropListFont();
}

void xPropertyGrid::SetPropListFont()
{
