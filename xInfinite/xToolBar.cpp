...
xOpToolBar::xOpToolBar()
	: mOnInitUI(xApp::OnInitUI, this, &xOpToolBar::Init)
	, mOnRender(RenderEvent::OnAfterRender, this, &xOpToolBar::Render)
	, mOnShutdown(xApp::OnShutdown, this, &xOpToolBar::Shutdown)
	, mOnUpdate(xApp::OnUpdate, this, &xOpToolBar::Update)
{
	INIT_SLN;
	mNumButtons = 0;
	mCheckedButton = -1;
